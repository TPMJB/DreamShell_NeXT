...
These apps are included in the complete NeXT package. Follow the
[installation guide](../docs/installation.md) and copy the full **DS** folder
so the core, modal keyboard, fonts, modules and apps match. A working NeXT
3.0/3.1 boot disc can continue loading the updated installation.

Included versions: File Manager 2.0.1, GD Play/Settings 2.0.2, BIOS Flasher
3.0.1, and Region Changer/Speedtest/Memtest/Network 2.0.1.
...
The full-build workflow compiles and links the SH-4 modules, runs host behavior
checks and validates the complete package. Its default is an artifact; publishing
a GitHub release is an explicit option.
...
Include FAT32/exFAT copy, GD Play drive transitions and Settings persistence
across reboot in the release-candidate console check.
