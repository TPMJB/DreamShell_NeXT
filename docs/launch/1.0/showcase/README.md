# K-UI 1.0 — tool-by-tool showcase
...
This repeats the individual-app format of the [NeXT 0.9 gallery](https://github.com/TPMJB/DreamShell_NeXT/blob/74f82fc98918249f3a08aec56e43ee90d8e340bb/docs/screenshots/README.md), with the K-UI identity and current feature explanations.

![K-UI overview](00-k-ui-overview.jpg)

## Suggested Reddit gallery

Use the square cover from the parent launch kit, then Launcher, GD Ripper, Advanced/recovery, Games, ISO Loader, VMU Manager and File Manager. Attach a real-console clip separately. Use the remaining utility cards in the forum post or a follow-up.
